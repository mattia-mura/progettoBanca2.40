...
public class MainFrame extends JFrame {
    ...
    public void nuovoInvestimento() {
        ...
        investimenti.add(new Investimenti(InvestiFrame.getTempInvestimenti(), InvestiFrame.getImportoInvestimento()));
        contoVirtuale.aumentaSaldo(InvestiFrame.getImportoInvestimento());
        aggiornaUI();
    }
