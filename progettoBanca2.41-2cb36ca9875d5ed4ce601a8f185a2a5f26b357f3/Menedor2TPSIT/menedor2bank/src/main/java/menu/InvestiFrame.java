...
public class InvestiFrame extends JFrame {
    ...
    private static double importoInvestimento = 0;

    int nMaxInvestimenti = 5;
    int nInvestimenti = 0;
    static int tempInvestimenti;
...
//    }
    ...
    public static  double getImportoInvestimento() {
        return importoInvestimento;
    }

    public static int getTempInvestimenti() {
