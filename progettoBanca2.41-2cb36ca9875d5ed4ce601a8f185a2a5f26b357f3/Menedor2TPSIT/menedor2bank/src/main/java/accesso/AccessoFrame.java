...
public class AccessoFrame extends JFrame {
    ...
    private accesso.AccessoUtenteMain aU = new accesso.AccessoUtenteMain();
    //JLabel logo = new JLabel(new ImageIcon(getClass().getResource("/logo_MenedorBank.png")));
    JLabel logo = new JLabel(new ImageIcon("C:/Users/Michele/Desktop/progettoBanca2.41-2cb36ca9875d5ed4ce601a8f185a2a5f26b357f3/Menedor2TPSIT/menedor2bank/src/main/resources/Logo_MenedroBank.png"));
    //URL imgURL = getClass().getClassLoader().getResource("Logo_MenedorBank.png");
    //JLabel logo = new JLabel(new ImageIcon(Objects.requireNonNull(getClass().getClassLoader().getResource("Logo_MenedorBank.png"))));
    ...
    private void login() {
        ...
        if (username.isEmpty() || password.isEmpty()) {
            ...
            if (aU.findUtent(username, password)) {
                if(accesso.AccessoUtenteMain.findUtent(username, password)){
    ...
    private void confermaRegistrazione(JTextField nuovoCampoUsername, JPasswordField nuovoCampoPassword, JPasswordField nuovoCampoConfermaPassword) {
        ...
        if (username.isEmpty() || password.isEmpty() || confermaPassword.isEmpty()) {
            ...
            if (!password.equals(confermaPassword)) {
                ...
                if(accesso.AccessoUtenteMain.addUtent(username, password)){
